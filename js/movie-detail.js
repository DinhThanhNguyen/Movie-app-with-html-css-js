...
const filterVideos = function (videoList) {
    return videoList.filter(({ type, site }) => (type === "Featurette" || type === "Teaser") && site === "YouTube");
};

fetchDataFromServer(
    `${baseURL}/movie/${movieId}?api_key=${api_key}&append_to_response=casts,videos,images,releases`,
    function (movie) {
        const {
            backdrop_path,
            poster_path,
        ...
        fetchDataFromServer(`${baseURL}/movie/${movieId}/recommendations?api_key=${api_key}&page=1`, addSuggestedMovies)
    },
);
